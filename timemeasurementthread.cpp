...
#include "./algoritmi_studentski_projekti/maximumemptyrectangle.h"
...
//            break;
       /* case TipAlgoritma::PRESEK_PRAVOUGAONIKA:
            ...
            break;*/
         case TipAlgoritma::MAXIMUM_EMPTY_RECTANGLE:
             pAlgorithm = new MaximumEmptyRectangle(nullptr, 0, false, "", i);
             break;
        default:
            break;
        }
